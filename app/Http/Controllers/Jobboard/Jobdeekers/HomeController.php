...
class HomeController  extends FrontJobboardController
{
    public $msg = [];
    ...
    {		
		$request->session()->set('jb_type','jobseekers');		
        ...
        return view('jobboard.jobseekers.index',$data);
    }
	...
	{		
		...
		if(!$request->session()->get('seekers_is_logged_in')){
				return redirect('job-seekers-login');					 									 
			}
		
		$data['job_detail']  = DB::table('jb_employers_job_post')
								 ->select('jb_employers_job_post.*','jb_categories.name','jb_seekers_basic_info.company_name','jb_seekers_basic_info.company_name')
								 ->join('jb_categories', 'jb_categories.id', '=', 'jb_employers_job_post.category_id')
								 ->join('jb_seekers_basic_info', 'jb_seekers_basic_info.id', '=', 'jb_employers_job_post.jb_seekers_basic_info_id')
	...
	{		
	   ...
	   $jb_seekers_basic_info_id = $request->input('jb_seekers_basic_info_id');  
	   ...
	   DB::table('jb_application_job')->insert(['salary' => $salary,
											'jb_seekers_basic_info_id' => $jb_seekers_basic_info_id,											
    ...
    {	   		
		...
		DB::table('jb_seekers_basic_info')->insert([

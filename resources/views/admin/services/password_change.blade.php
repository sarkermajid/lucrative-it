                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" value="{{ old('password') }}" placeholder="Enter Password" id="password" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="password">New Confirm Password</label>
                                <input type="password" name="confirm_password" value="{{ old('confirm_password') }}" placeholder="Enter Confirm Password" id="password" class="form-control" required>
                            </div>
                        </div>
                        <!-- /.box-body -->

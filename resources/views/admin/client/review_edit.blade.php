                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                    {!! Form::model($clientReview, ['route' => ['reviewUpdate', $clientReview->id], 'method' => 'PUT', 'files' => true]) !!}
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" class="form-control" value="{{$clientReview->name}}" required name="name">
                                            </div>
                                            <div class="form-group">
                                                <label>Designation</label>
                                                <input type="text" class="form-control" value="{{$clientReview->designation}}" required name="designation">
                                            </div>
                                            <div class="form-group">
                                                <label>Review</label>
                                                <textarea type="text" value="{{old('review')}}" class="form-control" required name="review">{{ $clientReview->review }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Image</label>
                                                <img src="{{ asset('images/client/'.$clientReview->image) }}" height="50" width="70" alt="">
                                                <p class="image_name"></p>
                                                <div class="input-group">
                                                <tr>
                                                    <button><input type="file" name="image" id="fileToUpload"></button>
                                                </tr>
                                                    <input id="thumbnail" class="form-control" type="hidden" value="{{$clientReview->image}}" name="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        <footer>
                                            ...
                                            <a  class="btn btn-default" href="{{url('admin/review-list')}}">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>

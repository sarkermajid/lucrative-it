                        ...
                        <div class="jarviswidget" id="wid-id-1" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-custombutton="false">
                            ...
                            <div>
                                <div class="widget-body">
                                    {!! Form::model($portfolioType, ['route' => ['typeUpdate', $portfolioType->id], 'method' => 'PUT', 'files' => true]) !!}
                                    <div class="row">
                                        <div class="col-md-8">

                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" class="form-control" value="{{$portfolioType->title}}" required name="title">
                                            </div>
                                            <div style="margin-bottom: 10px;">
                                                <label>Status</label>
                                                <label class="select">
                                                    {!! Form::select('status', ['Active' => 'Active','InActive' => 'InActive'], $portfolioType->status,['class'=>'form-control']) !!}<i></i>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <footer>
                                            ...
                                            <a  class="btn btn-default" href="{{url('admin/add-type-list')}}">Back</a>
                                        </footer>
                                    {!! Form::close() !!}
                                </div>
                            </div>
